...
enum ContainerStore {
    ...
    static func applicationBundleMetadataCatalog() -> [String: ApplicationBundleMetadata] {
        if let cached = BrowserDiscoveryCache.cachedMetadata() {
            return cached
        }
        ...
        BrowserDiscoveryCache.storeMetadata(catalog)
        return catalog
    }
    ...
    static func dynamicAppIdentifiers() -> [String] {
        if let cached = BrowserDiscoveryCache.cachedIdentifiers() {
            return cached
        }
        ...
        BrowserDiscoveryCache.storeIdentifiers(identifiers)
        return identifiers
    }
    ...
    static func launchServicesStoreIdentifiers() -> [String] {
        if let cached = BrowserDiscoveryCache.cachedLaunchServices() {
            return cached
        }
        ...
        BrowserDiscoveryCache.storeLaunchServices(identifiers)
        return identifiers
    }
